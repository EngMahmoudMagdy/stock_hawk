...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.price.setContentDescription(String.format(Locale.getDefault(),"%f",cursor.getFloat(Contract.Quote.POSITION_PRICE)));
    ...
    class StockViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int percentChangeColumn = cursor.getColumnIndex(Contract.Quote.COLUMN_PERCENTAGE_CHANGE);
            int absChangeColumn = cursor.getColumnIndex(Contract.Quote.COLUMN_ABSOLUTE_CHANGE);

            clickHandler.onClick(
                    cursor.getString(symbolColumn),
                    cursor.getString(historyColumn),
                    cursor.getString(nameColumn),
                    cursor.getFloat(priceColumn),
                    cursor.getFloat(percentChangeColumn),
                    cursor.getFloat(absChangeColumn));
